    ...
    <section className="relative py-24 md:py-40 overflow-hidden">
      ...
      <div className="section-container relative z-10 text-center">
        <h2 className="font-display text-4xl md:text-7xl font-semibold text-white tracking-[-0.03em] leading-[0.95] max-w-4xl mx-auto mb-8">
          ...
          <span className="text-gradient-shine">case study</span>.
        </h2>
        <p className="text-lg text-white/55 max-w-xl mx-auto mb-10">
          We take on a small number of engagements each quarter. If you&apos;re
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <MagneticButton variant="outline" size="lg" href="/services">
            See Services
          </MagneticButton>
        </div>
      </div>
